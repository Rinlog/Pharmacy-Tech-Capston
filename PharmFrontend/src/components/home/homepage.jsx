            ...
            <div className="home-content">
                <div className="button-grid">
                    <div className="button-with-image">
                        ...
                        <img src="/images/medipills.jpg" alt="pills" className="pictures-rounded hide" onLoad={displayOnLoad}/>
                    ...
                    <div className="button-with-image">
                        ...
                        {Loaded == false && loadingSVG}
                        <img src="/images/phys.jpg" alt="Physicians" className="pictures-rounded hide"onLoad={displayOnLoad}/>
                    </div>
                    <div className="button-with-image">
                        {Loaded == false && loadingSVG}
                        <img src="/images/patients.jpg" alt="patients" className="pictures-rounded hide" onLoad={displayOnLoad}/>
                    ...
                    <div className="button-with-image">
                        ...
                        {Loaded == false && loadingSVG}
                        <img src="/images/orders.jpg" alt="orders" className="pictures-rounded hide" onLoad={displayOnLoad}/>
                    </div>
                    <div className="button-with-image">
                    {Loaded == false && loadingSVG}
                        <img src="/images/verification.jpg" className="pictures-rounded hide" onLoad={displayOnLoad}/>
                    ...
                    {authState.loggedIn && authState.isAdmin && (
                        <>
                            ...
                            <div className="button-with-image">
                                {Loaded == false && loadingSVG}
                                <img src="/images/usermanagement.jpg" alt="usermanagement" className="pictures-rounded hide" onLoad={displayOnLoad}/>
                            ...
                            <div className="button-with-image">
                                ...
                                {Loaded == false && loadingSVG}
                                <img src="/images/logs.jpg" alt="Logs" className="pictures-rounded hide" onLoad={displayOnLoad}/>
                            </div>
