            ...
            let CurrentOrder = (
                <tr key={Order["Rx Number"]}>
                    ...
                    {Order["Status"] == "Approved" && Order["printStatusID"] == "" && cookies.user == Order["verifier"]&&(
                        <td><button id="PrintOrder" orderid={Order["Rx Number"]} qa-id={Order["Comments"] == "Generated By QATESTS" ? "PrintTest" : ""} onClick={handleShow}>Print</button></td>
                    )}
                    {Order["Status"] == "Approved" && Order["printStatusID"] != "" && cookies.user == Order["verifier"]&&(
                        <td><button id="RePrintOrder" orderid={Order["Rx Number"]} qa-id={Order["Comments"] == "Generated By QATESTS" ? "RePrintTest" : ""} onClick={handleShow}>Reprint</button></td>
                    )}
