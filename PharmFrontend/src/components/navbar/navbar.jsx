        ...
        <Link to="/home" className="navbar-item">
          ...
          <Dropdown className="pl-2">
            <Dropdown.Toggle className='HideButtonCSS'>
              <span>
                <svg height="30px" width="30px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 60.671 60.671" xmlSpace="preserve" fill="#000000">
